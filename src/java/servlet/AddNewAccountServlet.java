 ...
 * @author tranh
 */
@WebServlet(name = "AddNewAccountServlet", urlPatterns = {"/addNewAccount"})
public class AddNewAccountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        isSuccess = stockDAO.addNewAccount(productID, email, password, dueDate);
        boolean isAddedAcc = true;
        ...
        request.setAttribute("isAddedAcc", isAddedAcc);
